...
public class WinUIDialogService : IDialogService
{
    ...
    public WinUIDialogService(IDialogFactory dialogFactory, ILocalizationService localizationService)
    {
    ...
    public async Task ShowDialogAsync(DialogKey dialogKey)
        => await ShowDialogAsync(dialogKey, null);

    public async Task ShowDialogAsync(DialogKey dialogKey, object? parameter)
    {
        ...
        var dialog = _dialogFactory.Create(dialogKey, parameter);
